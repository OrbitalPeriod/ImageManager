...
namespace ImageManager.Migrations
{
    ...
    [Migration("20260127013310_AddFolderSystem")]
    partial class AddFolderSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ImageManager.Data.Models.Folder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("Folders", "identity");
                });

            modelBuilder.Entity("ImageManager.Data.Models.FolderImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("FolderId", "UserOwnedImageId")
                        .IsUnique();

                    b.ToTable("FolderImages", "identity");
                });
            ...
            modelBuilder.Entity("ImageManager.Data.Models.PlatformSyncLog", b =>
                {
                    ...
                    b.Property<Guid>("PlatformTokenId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PlatformTokenId");

                    b.ToTable("PlatformSyncLogs", "identity");
                });
            ...
            modelBuilder.Entity("ImageManager.Data.Models.FolderImage", b =>
                {
                    b.HasOne("ImageManager.Data.Models.Folder", "Folder")
                        .WithMany("FolderImages")
            ...
            modelBuilder.Entity("ImageManager.Data.Models.PlatformSyncLog", b =>
                {
                    b.HasOne("ImageManager.Data.Models.PlatformToken", "PlatformToken")
                        .WithMany()
                        .HasForeignKey("PlatformTokenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PlatformToken");
                });
